...
int main(int argc, char* argv[]) {
    ...
    container.create_connection("START.CNF", "INT2INT.REQ");
    container.create_connection("INT2INT.CNF", "INT2INT_1.REQ");
    container.create_connection("INT2INT_1.CNF", "F_ADD.REQ");
    container.create_connection("F_ADD.CNF", "PRINT.REQ");

    container.create_connection("INT2INT.OUT", "F_ADD.IN1");
    container.create_connection("INT2INT_1.OUT", "F_ADD.IN2");
    container.create_connection("F_ADD.OUT", "PRINT.IN");    
